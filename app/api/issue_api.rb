...
module IssueApi
  class API < Grape::API
    ...
    params do
      ...
      optional :tags, type: Array[String], desc: 'An array of tags all the issues must have, e.g. ["taga","tagb"]', coerce_with: JSON, documentation: { type: 'tag', is_array: true }
      optional :excluding_tags, type: Array[String], desc: 'An array of tags that the issues must not have, e.g. ["taga","tagb"]', coerce_with: JSON, documentation: { type: 'tag', is_array: true }
