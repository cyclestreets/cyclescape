...
class PlanningFilter < ApplicationRecord
  LOCAL_AUTHORITIES = [
    ...
    "Brent", "Brentwood", "Bridgend", "Brighton", "Bristol", "Broadland", "Broads", "Bromley", "Bromsgrove",
    ...
    "Eastleigh", "Eden", "Edinburgh", "Elmbridge", "Enfield", "Epping Forest", "Epsom and Ewell",
    ...
    "Gravesham", "Great Yarmouth", "Greater Manchester", "Greenwich", "Guernsey", "Guernsey Bailiwick", "Guildford",
