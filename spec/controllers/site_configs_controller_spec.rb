...
RSpec.describe SiteConfigsController, type: :controller do
  ...
  describe "GET #index" do
    it "assigns all site_configs as @site_configs" do
      ...
      expect(assigns(:site_configs)).to eq([site_config])
    end
  end
  ...
  describe "GET #show" do
    it "assigns the requested site_config as @site_config" do
      ...
      expect(assigns(:site_config)).to eq(site_config)
    end
  end
  ...
  describe "GET #new" do
    it "assigns a new site_config as @site_config" do
      ...
      expect(assigns(:site_config)).to be_a_new(SiteConfig)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new SiteConfig" do
        expect {
          post :create, {:site_config => valid_attributes}, valid_session
        }.to change(SiteConfig, :count).by(1)
      end

      it "assigns a newly created site_config as @site_config" do
        post :create, {:site_config => valid_attributes}, valid_session
        expect(assigns(:site_config)).to be_a(SiteConfig)
        expect(assigns(:site_config)).to be_persisted
      end

      it "redirects to the created site_config" do
        post :create, {:site_config => valid_attributes}, valid_session
        expect(response).to redirect_to(SiteConfig.last)
      end
    end

    context "with invalid params" do
      it "assigns a newly created but unsaved site_config as @site_config" do
        post :create, {:site_config => invalid_attributes}, valid_session
        expect(assigns(:site_config)).to be_a_new(SiteConfig)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested site_config" do
        site_config = SiteConfig.create! valid_attributes
        put :update, {:id => site_config.to_param, :site_config => new_attributes}, valid_session
        site_config.reload
      ...
      it "redirects to the site_config" do
        site_config = SiteConfig.create! valid_attributes
        put :update, {:id => site_config.to_param, :site_config => valid_attributes}, valid_session
        expect(response).to redirect_to(site_config)
      end
    end
    ...
    context "with invalid params" do
      it "assigns the site_config as @site_config" do
        site_config = SiteConfig.create! valid_attributes
        put :update, {:id => site_config.to_param, :site_config => invalid_attributes}, valid_session
        expect(assigns(:site_config)).to eq(site_config)
      end
  ...
  describe "DELETE #destroy" do
    ...
    it "redirects to the site_configs list" do
      site_config = SiteConfig.create! valid_attributes
      delete :destroy, {:id => site_config.to_param}, valid_session
      expect(response).to redirect_to(site_configs_url)
    end
  end
