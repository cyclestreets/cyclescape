...
describe "Group Membership Requests" do
  ...
  context "as a group member" do
    ...
    describe "viewing the requests" do
      it "should refuse" do
        expect { visit group_membership_requests_path(gmr.group) }.to raise_error Pundit::NotAuthorizedError
  ...
  context "as a committee member" do
    ...
    describe "when being invited as a new member" do
      ...
      it "should let you complete the invitation and change name and email" do
        ...
        invitation_token = mail.html.match(/invitation_token=(.*?)"/)[1]
        ...
        updated_user = User.find_by(email: "some_other_email@example.com")
