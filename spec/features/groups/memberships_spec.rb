  ...
  context "as an admin" do
    ...
    context "create" do
      ...
      it "should create a new group member and send an invitation email" do
        ...
        expect(User.find_by(email: "briang@example.com")).to be_truthy
      ...
      context "with existing user" do
        ...
        it "should use an existing user if present" do
          ...
          click_button "Add member"
          expect(User.find_by(email: new_member.email).groups).to include(group)
        end
      end
    end
  end
  ...
  context "as a group committee member" do
    ...
    context "create" do
      ...
      it "should create a new group member and send an invitation email" do
        ...
        click_button "Add member"
        expect(User.find_by(email: "meg@example.com")).to be_truthy
