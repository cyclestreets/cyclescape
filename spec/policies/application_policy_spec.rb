...
RSpec.describe ApplicationPolicy do
  describe "#view_full_name?" do
    subject(:view_full_name) { described_class.new(current_user, nil).view_full_name?(user_being_viewed) }

    let(:current_user) { build_stubbed :user }

    context "when user_being_viewed has a private profile" do
    ...
    context "when current_user is in a committee and being viewed is not public" do
